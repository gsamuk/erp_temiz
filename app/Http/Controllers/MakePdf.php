...
class MakePdf extends Controller
{
    ...
    {
        $data = LogoItemsPhoto::where('id', '>', $id)->distinct()->orderby('insert_time', 'desc')->get('logo_stockref');
    ...
    public function print($id)
    {
        ...
        $pdf = PDF::loadView('DemandPrint', [
            'duser' => $duser,
            'talep' => $talep,
            'detay' => $detay,
            'depo' => $depo,
            'depo_hedef' => $depo_hedef
        ], array(), 'UTF-8');
