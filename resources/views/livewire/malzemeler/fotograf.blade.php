  ...
  <div class="row">
    <div class="col-lg-5 col-md-12 col-sm-12 p-1">
      ...
      <div class="card">
        <div class="card-body">
          ...
          @if ($data)
            <table class="table-nowrap table-sm mt-2 table align-middle">
              <thead>
                <tr>
    ...
    @if ($ref > 0)
      <div class="col-lg-7 col-md-6 p-1">
        <div class="card ribbon-box mb-lg-0 border shadow-none">
              ...
              <div class="form-group boxed">
                <form wire:submit.prevent="save">
                  ...
                  <label for="file" class="btn btn-info btn-label rounded-pill"><i
                       class="ri-image-fill label-icon rounded-pill fs-16 me-2 align-middle"></i>
        ...
        @if ($item_photos)
          <div class="card card-border-light border">
            <div class="card-body">
              <div class="row">
                    ...
                    <div class="bg-light m-1 p-2">
                      <div>
                        <img class="img-thumbnail"
                             src="{{ asset('public/files/images/items/thumb/' . $p->foto_path) }}">
                      </div>
                      <div>
