...
@section('title') @lang('translation.scrollbar') @endsection
@section('content')
@component('components.breadcrumb')
    @slot('li_1') Advance UI @endslot
    @slot('title') Scrollbar @endslot
@endcomponent
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-simplebar</code> attribute and add <code>max-height: **px</code>
                        to set default scrollbar.</p>
                                    ...
                                    <a href="#!" class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 text-muted">
                                                <p class="m-0">Your <span
                                                        class="fw-semibold text-dark">Elite</span> author Graphic
                                                    Optimization <span class="text-secondary">reward</span> is ready!</p>
                                    ...
                                    <a href="#!" class="text-reset notification-item d-block dropdown-item active">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 text-muted">
                                                ...
                                                <p class="mb-0">Answered to your comment on the cash flow
                                                    forecast's graph 🔔.</p>
                                            </div>
