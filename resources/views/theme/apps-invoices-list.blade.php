                                ...
                                <tbody class="list form-check-all">
                                    <tr>
                                        ...
                                        <td class="status"><span
                                                class="badge badge-soft-success text-uppercase">Paid</span></td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item" href="apps-invoices-details"><i
                                                                class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                            View</a></li>
                                                    <li><a class="dropdown-item" href="apps-invoices-create"><i
                                    ...
                                    <tr>
                                        ...
                                        <td class="status"><span
                                                class="badge badge-soft-warning text-uppercase">Unpaid</span></td>
                                        <td>
                                            <div class="dropdown">
                                                <button class="btn btn-soft-secondary btn-sm dropdown" type="button"
                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <tr>
                                        ...
                                        <td class="status"><span
                                                class="badge badge-soft-danger text-uppercase">Cancel</span></td>
                                        <td>
                                            <div class="dropdown">
                                                <button class="btn btn-soft-secondary btn-sm dropdown" type="button"
                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <tr>
                                        ...
                                        <td class="status"><span
                                                class="badge badge-soft-primary text-uppercase">Refund</span></td>
                                        <td>
                                            <div class="dropdown">
                                                <button class="btn btn-soft-secondary btn-sm dropdown" type="button"
                                                    data-bs-toggle="dropdown" aria-expanded="false">
