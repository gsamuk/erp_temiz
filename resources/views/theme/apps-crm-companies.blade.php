                            ...
                            <tbody class="list form-check-all">
                                <tr >
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/brands/dribbble.png') }}" alt="" class="avatar-xxs rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/brands/bitbucket.png') }}" alt="" class="avatar-xxs rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/companies/img-8.png') }}" alt="" class="avatar-xxs rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/companies/img-1.png') }}" alt="" class="avatar-xxs rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/companies/img-6.png') }}" alt="" class="avatar-xxs rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td >
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/brands/dropbox.png') }}" alt="" class="avatar-xxs rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/brands/mail_chimp.png') }}" alt="" class="avatar-xxs rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/companies/img-3.png') }}" alt="" class="avatar-xxs rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/companies/img-4.png') }}" alt="" class="avatar-xxs rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="name">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('assets/images/brands/slack.png') }}" alt="" class="avatar-xxs rounded-circle">
                                            </div>
                                            <div class="flex-grow-1 ms-2 name">Syntyce Solutions</div>
                                        </div>
                                    </td>
