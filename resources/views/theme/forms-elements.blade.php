                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <p class="text-muted">Use <code>form-control </code>class and
                                        <code>type="file"</code> attribute within the input attribute to set a default size
                                        file input.</p>
                    ...
                    <div class="live-preview">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-muted">Input groups wrap by default via <code>flex-wrap: wrap</code> in
                                order to accommodate custom form field validation within an input group. You may disable
                                this with <code>flex-nowrap</code> class.</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>input-group-sm</code> class to set a small size input group and
                        ...
                        a large size input group respectively. no such class is required for a default size input group.</p>
                    <div class="live-preview">
                        <div class="row align-items-center g-3">
                            <div class="col-lg-4">
