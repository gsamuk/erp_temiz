                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" data-provider="flatpickr"
                                                id="JoiningdatInput" data-date-format="d M, Y" placeholder="Select date" />
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-12">
                        ...
                        <div class="tab-pane" id="privacy" role="tabpanel">
                                ...
                                <div class="d-flex flex-column flex-sm-row mb-4 mb-sm-0">
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted">Two-factor authentication is an enhanced security
                                            meansur. Once enabled, you'll be required to give two types of identification
                                            when you log into Google Authentication and SMS are Supported.</p>
                                    </div>
                            ...
                            <div>
                                ...
                                <p class="text-muted">Go to the Data & Privacy section of your profile Account. Scroll
                                    to "Your data & privacy options." Delete your Profile Account. Follow the instructions
