                                            ...
                                            <ul class="departments">
                                                ...
                                                <li class="department">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="javascript:void(0);"><span>Profile Settings</span></a>
                                                        </li>
                                                        <li><a href="javascript:void(0);"><span>Modify
                                                                    Reservation</span></a></li>
                                                        <li><a href="javascript:void(0);"><span>Cancel
                                                                    Reservation</span></a></li>
                                                        <li><a href="javascript:void(0);"><span>Write Reviews</span></a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="department">
                                                ...
                                                <li class="department">
                                                    <a href="javascript:void(0);" class="fw-semibold"><span>Book a
                                                            Trip</span></a>
                                                    <ul>
                                                        <li><a href="javascript:void(0);"><span>Travel Details</span></a>
                                                        </li>
                                                        <li><a href="javascript:void(0);"><span>Reservation
                                                                    Process</span></a></li>
                                                        <li><a href="javascript:void(0);"><span>Payment Option</span></a>
                                                        </li>
                                                ...
                                                <li class="department">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="javascript:void(0);"><span>Tracking Camp</span></a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="department">
                                                    <a href="javascript:void(0);" class="fw-semibold"><span>Travel
                                                            Tips</span></a>
                                                    <ul>
                                                        <li><a href="javascript:void(0);"><span>General Travel</span></a>
                                                        </li>
                                                        <li><a href="javascript:void(0);"><span>Helpth Concerns</span></a>
                                                        </li>
                                                        <li><a href="javascript:void(0);"><span>Safety Measures</span></a>
                                                        </li>
                            ...
                            <div class="verti-sitemap">
                                <ul class="mb-0">
                                    <li class="p-0 parent-title"><a href="javascript: void(0);"
                                            class="fw-medium fs-14">Nancy Martino - Project Director</a></li>
                                    <ul>
                                        <li>
                                            <a href="javascript: void(0);" class="fw-medium">Erica Kernan - Team
                                                Leader</a>
                                        ...
                                        <li>
                                            <a href="javascript: void(0);" class="fw-medium">Mary Jones - Project
                                                Manager</a>
                                            <ul class="second-list">
                                                <li><a href="javascript: void(0);">Jordyn Jones - Designer</a></li>
                                                <li><a href="javascript: void(0);">Ashlee Haney - Developer</a></li>
                                                <li><a href="javascript: void(0);">Rashad Charles - BackEnd Developer</a>
                                                </li>
                                                <li><a href="javascript: void(0);">Walter Newman - Frontend Developer</a>
                                                </li>
                                                <li><a href="javascript: void(0);">Adam Moss - Designer</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="javascript: void(0);" class="fw-medium">Tilly Kent - Executive
                                                Manager</a>
                                            <ul>
                                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="javascript: void(0);" class="fw-medium text-primary"><i
                                                    class="ri-airplay-line me-1 align-bottom"></i> Dashboards</a>
                                            <ul class="second-list">
                                                <li>
                                        ...
                                        <li>
                                            <a href="javascript: void(0);" class="fw-medium text-primary"><i
                                                    class="ri-pencil-ruler-2-line me-1 align-bottom"></i> App Pages</a>
                                            <ul class="second-list">
                                        ...
                                        <li>
                                            <a href="javascript: void(0);" class="fw-medium text-primary"><i
                                                    class="ri-file-list-3-line me-1 align-bottom"></i> Pages</a>
                                        </li>
                                        <li>
                                            <a href="javascript: void(0);" class="fw-medium text-primary"><i
                                                    class="ri-stack-line me-1 align-bottom"></i> Components</a>
                                            <ul>
                                                <li>
