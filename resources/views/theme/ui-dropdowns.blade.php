    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-bs-offset</code> or <code>data-bs-reference</code> to change
                        the position of the dropdown.</p>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Example of dropdown menu containing <code>Headers, Text and Forms</code>
                        content.</p>
                    <div class="live-preview">
                                        ...
                                        <div class="p-3">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-auto dropdown-tabs">
                                                    <span class="badge badge-soft-light fs-13" data-key="t-view-all"> 4
                                                        New</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab1"
                                            ...
                                            <div data-simplebar style="max-height: 300px;" class="pe-2">
                                                ...
                                                <div class="my-3 text-center">
                                                    <button type="button"
                                                        class="btn btn-soft-success waves-effect waves-light">View All
                                                        Notifications <i
                                        ...
                                        <div class="tab-pane fade py-2 ps-2" id="messages-tab1" role="tabpanel"
                                            ...
                                            <div data-simplebar style="max-height: 300px;" class="pe-2">
                                                ...
                                                <div class="my-3 text-center">
                                                    <button type="button"
                                                        class="btn btn-soft-success waves-effect waves-light">View All
                                                        Messages <i class="ri-arrow-right-line align-middle"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="dropdown-head bg-success bg-pattern rounded-top">
                                        ...
                                        <div class="px-2 pt-2">
                                            <ul class="nav nav-tabs dropdown-tabs nav-tabs-custom"
                                                ...
                                                <li class="nav-item waves-effect waves-light">
                                                    <a class="nav-link active" data-bs-toggle="tab" href="#all-noti-tab2"
                                                        role="tab" aria-selected="true">
                                                        All (4)
                                                    </a>
                                                </li>
                                    ...
                                    <div class="dropdown-head bg-secondary bg-pattern rounded-top">
                                        ...
                                        <div class="px-2 pt-2">
                                            <ul class="nav nav-tabs dropdown-tabs nav-tabs-custom"
                                                ...
                                                <li class="nav-item waves-effect waves-light">
                                                    <a class="nav-link active" data-bs-toggle="tab" href="#all-noti-tab3"
                                                        role="tab" aria-selected="true">
                                                        All (4)
                                                    </a>
                                                </li>
