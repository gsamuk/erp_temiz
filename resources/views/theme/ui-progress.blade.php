...
@section('content')
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">Use <code>bg-</code> class to progress bar class with the below-mentioned
                        color variation to set the background color progress bar.</p>
    ...
    &lt;/div&gt;</code></pre>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>bg-</code> class to progress bar class with the below-mentioned
                        color to change the appearance of individual progress bars.</p>
    ...
    &lt;/div&gt;</code></pre>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">Use <code>progress-bar-striped progress-bar-animated</code> class to add
                        strip with animation to the progress.</p>
    ...
    &lt;/div&gt;</code></pre>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>animated-progess</code> class to show progress with animation.</p>
                    <div class="live-preview">
                    ...
                    <div class="d-none code-view">
                        <pre class="language-markup">
    <code>&lt;div class=&quot;progress animated-progess&quot;&gt;
        &lt;div class=&quot;progress-bar bg-primary&quot; role=&quot;progressbar&quot; style=&quot;width: 15%&quot; aria-valuenow=&quot;15&quot; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot;&gt;&lt;/div&gt;
    &lt;/div&gt;
    &lt;div class=&quot;progress animated-progess&quot;&gt;
        &lt;div class=&quot;progress-bar bg-success&quot; role=&quot;progressbar&quot; style=&quot;width: 25%&quot; aria-valuenow=&quot;25&quot; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot;&gt;&lt;/div&gt;
    ...
    <div class="row">
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>animated-progess custom-progess </code> class to show custom
                        progress with animation.</p>
                    <div class="live-preview">
                    ...
                    <div class="d-none code-view">
                        <pre class="language-markup">
    <code>&lt;div class=&quot;progress animated-progess custom-progress mb-4&quot;&gt;
        &lt;div class=&quot;progress-bar bg-primary&quot; role=&quot;progressbar&quot; style=&quot;width: 15%&quot; aria-valuenow=&quot;15&quot; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot;&gt;&lt;/div&gt;
    &lt;/div&gt;
    &lt;div class=&quot;progress animated-progess custom-progress mb-4&quot;&gt;
        &lt;div class=&quot;progress-bar bg-success&quot; role=&quot;progressbar&quot; style=&quot;width: 25%&quot; aria-valuenow=&quot;25&quot; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot;&gt;&lt;/div&gt;
    ...
    &lt;/div&gt;</code></pre>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>animated-progess custom-progess progress-label</code> class to show
                    ...
                    <div class="live-preview">
                        ...
                        <div class="card bg-light overflow-hidden shadow-none">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0"><b class="text-secondary">30%</b> Update in progress...
                                        </h6>
                                    </div>
                                    <div class="flex-shrink-0">
                        ...
                        <div class="card bg-light overflow-hidden shadow-none">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0"><b class="text-success">60%</b> Update in progress...
                                        </h6>
                                    </div>
                                    <div class="flex-shrink-0">
                        ...
                        <div class="card bg-light overflow-hidden shadow-none">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0"><b class="text-danger">82%</b> Update in progress...
                                        </h6>
                                    </div>
                                    <div class="flex-shrink-0">
    ...
    &lt;/div&gt;</code></pre>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted pb-2">Here is the example of progress which is represented by steps completion.
                    </p>
    ...
    &lt;/div&gt;</code></pre>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted pb-2">Use <code>progress-step-arrow </code>class to create step progress with an
                        arrow.</p>
