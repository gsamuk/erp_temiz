...
@section('title') @lang('translation.project-list') @endsection
@section('content')
                    ...
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted text-truncate-two-lines mb-3">Resign a landing page design. as per abc
                                    minimal design.</p>
                            </div>
                        </div>
                        <div class="mt-auto">
                    ...
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted text-truncate-two-lines mb-3">Create a Chat application for business
                                    messaging needs. Collaborate efficiently with secure direct messages and group chats.
                                </p>
                            </div>
                        </div>
                        <div class="mt-auto">
                    ...
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted text-truncate-two-lines mb-3">Create a project application for a
                                    project management and task management.</p>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-shrink-0">
                                <div><i class="ri-list-check align-bottom me-1 text-muted"></i> 13/26</div>
                            </div>
                        </div>
                        <div class="progress progress-sm animated-progess">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-shrink-0">
                                <div><i class="ri-list-check align-bottom me-1 text-muted"></i> 25/32</div>
                            </div>
                        </div>
                        <div class="progress progress-sm animated-progess">
