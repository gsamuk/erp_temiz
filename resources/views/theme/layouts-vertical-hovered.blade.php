...
@section('title') @lang('translation.hovered') @endsection
...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') Vertical Hovered Layout @endslot
    @endcomponent
    <div class="row">
        <div class="col-xxl-3">
                        ...
                        <li class="list-group-item px-0 pb-0">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <p class="fs-12 mb-0 text-muted"><i
                                            class="mdi mdi-circle fs-10 align-middle text-success me-1"></i>DASH</p>
                                </div>
                                <div class="flex-shrink-0 text-end">
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex flex-wrap gap-4 align-items-center">
                                            ...
                                            <p class="fw-medium text-muted mb-0">Low <span
                                                    class="text-dark fs-11 ms-1">0.0175489</span></p>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="d-flex">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fs-13 fw-medium mb-0">+13.11%<span
                                                class="text-muted ms-2 fs-10 text-uppercase">(btc)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fs-13 fw-medium mb-0">+15.08%<span
                                                class="text-muted ms-2 fs-10 text-uppercase">(ltc)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                            data-colors='["--vz-success", "--vz-transparent"]'
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fs-13 fw-medium mb-0">+08.57%<span
                                                class="text-muted ms-2 fs-10 text-uppercase">(etc)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                            data-colors='["--vz-success", "--vz-transparent"]'
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-danger fs-13 fw-medium mb-0">-09.21%<span
                                                class="text-muted ms-2 fs-10 text-uppercase">(bnb)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fs-13 fw-medium mb-0">+12.07%<span
                                                class="text-muted ms-2 fs-10 text-uppercase">(dash)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fs-13 fw-medium mb-0">+14.99%<span
                                                class="text-muted ms-2 fs-10 text-uppercase">(usdt)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-danger fs-13 fw-medium mb-0">-05.07%<span
                                                class="text-muted ms-2 fs-10 text-uppercase">(neo)</span></p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                        ...
                        <table class="table table-hover table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-success fs-13 mb-0"><i
                                                class="mdi mdi-trending-up align-middle me-1"></i>5.26</h6>
                                    </td>
                                    <td>$53,914.025</td>
                                    <td>1.25634801</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-danger fs-13 mb-0"><i
                                                class="mdi mdi-trending-down align-middle me-1"></i>3.07</h6>
                                    </td>
                                    <td>$75,854.127</td>
                                    <td>2.85472161</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-success fs-13 mb-0"><i
                                                class="mdi mdi-trending-up align-middle me-1"></i>7.13</h6>
                                    </td>
                                    <td>$44,152.185</td>
                                    <td>1.45612347</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-success fs-13 mb-0"><i
                                                class="mdi mdi-trending-up align-middle me-1"></i>0.97</h6>
                                    </td>
                                    <td>$48,367.125</td>
                                    <td>0.35734601</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-danger fs-13 mb-0"><i
                                                class="mdi mdi-trending-down align-middle me-1"></i>1.08</h6>
                                    </td>
                                    <td>$53,487.083</td>
                                    <td>3.62912570</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-success fs-13 mb-0"><i
                                                class="mdi mdi-trending-up align-middle me-1"></i>4.52</h6>
                                    </td>
                                    <td>$15,203.347</td>
                                    <td>1.85412740</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="text-success fs-13 mb-0"><i
                                                class="mdi mdi-trending-up align-middle me-1"></i>3.45</h6>
                                    </td>
                                    <td>$54,843.173</td>
                                    <td>0.95632087</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-middle">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1 lh-base"><a href="#" class="text-reset">One stop shop destination on all
                                    the latest news in crypto currencies</a></h6>
                    ...
                    <div class="d-flex mt-4">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1 lh-base"><a href="#" class="text-reset">Coin Journal is dedicated to
                                    delivering stories on the latest crypto</a></h6>
                    ...
                    <div class="d-flex mt-4">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1 lh-base"><a href="#" class="text-reset">The bitcoin-holding U.S. senator
                                    is trying to “fully integrate” crypto </a></h6>
                    ...
                    <div class="d-flex mt-4">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1 lh-base"><a href="#" class="text-reset">Cryptocurrency price like
                                    Bitcoin, Dash, Dogecoin, Ripple and Litecoin</a></h6>
