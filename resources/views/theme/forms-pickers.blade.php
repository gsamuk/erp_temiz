                        ...
                        <div class="row gy-3">
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <p class="text-muted">Set <code>data-provider="flatpickr" data-date-format="d M,
                                            Y"</code> attribute.</p>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mt-3">
                                    ...
                                    <p class="text-muted">Set <code>data-provider="flatpickr" data-altFormat="F j,
                                            Y"</code> attribute.</p>
                    ...
                    <form action="#">
                        <div class="row gy-3">
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <input type="text" class="form-control" data-provider="timepickr" data-time-hrs="true"
                                        id="timepicker-24hrs">
                                </div>
                            </div>
                            <!-- end col -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mt-3">
                                    ...
                                    <p class="text-muted">Set <code>data-provider="timepickr" data-default-time="Your
                                            Default Time"</code> attribute.</p>
                                    <input type="text" class="form-control" data-provider="timepickr"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mt-3">
                                    <label class="form-label mb-0">Inline</label>
                                    <p class="text-muted">Set <code>data-provider="timepickr" data-time-inline="Your
                                            Default Time"</code> attribute.</p>
                                    <input type="text" class="form-control" data-provider="timepickr"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div>
                                        ...
                                        <p class="text-muted">Use <code>monolith-colorpicker</code> class to set
                            ...
                            <div class="row g-4">
                                <div class="col-lg-4 col-md-6">
                                    <div class="mt-2">
                                        ...
                                        <p class="text-muted">Use <code>colorpicker-demo</code> class to set demo
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="mt-2">
                                        ...
                                        <p class="text-muted">Use <code>colorpicker-swatches</code> class to set switch
                                            colorpicker.</p>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="mt-2">
                                        ...
                                        <p class="text-muted">Use <code>colorpicker-input</code> class to set
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="mt-2">
                                        ...
                                        <p class="text-muted">Use <code>colorpicker-format</code> class to set
